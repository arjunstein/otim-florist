...
<template>
    ...
    <section class="mx-auto grid max-w-7xl gap-10 px-4 py-10 sm:px-6 sm:py-14 lg:grid-cols-2 lg:items-center lg:px-8 lg:py-20">
        <div>
            ...
            <div class="relative mt-6 grid aspect-[4/3] max-w-xl place-items-center overflow-hidden rounded-[2rem] border bg-secondary/70 shadow-sm">
                ...
                <span v-if="product.salePrice" class="absolute left-4 top-4 rounded-full bg-primary px-3 py-1.5 text-xs font-bold uppercase tracking-[0.14em] text-primary-foreground shadow-sm">
                    Promo
                </span>
            </div>
        </div>
