...
class Promopage extends Component
{
    ...
    public function mount()
    {
        ...
        OpenGraph::addImage(!empty($this->ad) && $this->ad->first() && !empty($this->ad->first()->image) ? 'https://otimflorist.com/storage/' . $this->ad->first()->image : '');
        ...
        JsonLd::addImage(!empty($this->ad) && $this->ad->first() && !empty($this->ad->first()->image) ? 'https://otimflorist.com/storage/' . $this->ad->first()->image : '');
